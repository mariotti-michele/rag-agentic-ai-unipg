...
- Se la domanda riguarda esclusivamente il calendario degli appelli di esame o le date degli appelli di esame (NON delle sessioni di laurea o del calendario delle festività o la data di inizio e fine dell'anno accademico), rispondi esattamente: "calendario esami"
- Se la domanda riguarda esclusivamente il calendario degli sessioni di laurea (NON degli appelli di esame o del calendario delle festività o la data di inizio e fine dell'anno accademico), rispondi: "calendario lauree"
