...
prompt_template = """Sei un assistente specializzato nella gestione dei regolamenti didattici del Corso di Laurea Magistrale in Ingegneria Informatica e Robotica.
